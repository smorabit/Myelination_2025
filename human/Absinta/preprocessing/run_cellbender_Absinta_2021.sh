...
cd /dfs3b/swaruplab/shared_lab/cross-disorder/count_matrices/MS_Absinta_2021_v3/
...
#     settings=$(head -n $index /dfs3b/swaruplab/shared_lab/cross-disorder/bin/Absinta_2021/cellbender_settings.csv | tail -n 1)
