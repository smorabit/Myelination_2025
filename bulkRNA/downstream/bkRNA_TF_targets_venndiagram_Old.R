...
for (cur_tf in TFnames) {
  ...
  # bulkRNA_Bach2_sub$log2FC_GFPvsBach2 <- bulkRNA_Bach2_sub$Log2.Fold.Change..GFP_vs_Bach2.
  # # bulkRNA_Bach2_sub$log2FC_Bach2vsGFP <- -1 * bulkRNA_Bach2_sub$Log2.Fold.Change..GFP_vs_Bach2.
  # bulkRNA_Bach2_sub$FDR <- bulkRNA_Bach2_sub$FDR..GFP_vs_Bach2.
  # bulkRNA_Bach2_sub$Pvalue <- bulkRNA_Bach2_sub$P.value..GFP_vs_Bach2.
  ...
  plot_p <- plot(
    p,
    fills = c("darkorchid3", "#72C2D6", '#8693E3'),  #
  ...
  ggsave(paste0(outPATH, "bulkRNA/ODC_Old/", "GFPvs", cur_tf, "_GeneOverlap_w", cur_tf,"_targets_venn.pdf"), plot = plot_p, width = 8, height = 6)
  ...
  sink(paste0(outPATH, "bulkRNA/ODC_Old/", "GFPvs", cur_tf, "_GeneOverlap_w", cur_tf,"_targets_calculation.txt"))
  print(go.obj)
  sink()
